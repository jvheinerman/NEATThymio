...
Written by Tjarco Kerssens and Cees Schouten

This manual explains how to use the code on this git when working with our equipment in the Robotlab of the VU in Amsterdam.
We are currently working on a more general manual and explanation of the equipment you need to start your own experiments in your own lab. 
Many students use this code and develop it further. We try to have the most recent version online but it might happen that some explanations are double or not consistent.
For questions you are welcome to contact j.v.heinerman@vu.nl
	...
	1. Setting Up
		...
		use cdm: git clone —recursive link_to_the_code

		e.g.	Phyton 2.7 (or up), OpenCV
	...
	2. Logging In
		...
		Manual available on PI website https://www.raspberrypi.org/documentation/remote-access/ssh/passwordless.md
	...
	7.	Using the logs
		...
		7. Either create csv files or visual representations of each NN with
			...
			cmd	python export_data FILE.json 
